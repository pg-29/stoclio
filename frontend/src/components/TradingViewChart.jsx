...
export default function TradingViewChart({ symbol, height = 320, theme = "light" }) {
  ...
  const tvSymbol = TV_SYMBOL_MAP[symbol] || `NSE:${symbol}`;
  useEffect(() => {
  ...
  return <div className="tradingview-widget-container" ref={containerRef} style={{ height, width: "100%", borderRadius: 10, overflow: "hidden" }} />;
}
